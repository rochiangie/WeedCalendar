...
{
    // Button component for settings of tutorial 
    public class LineTutorial
    {
        // Link to tutorial object
        private static TutorialArea.Tutorial Tutorial => AreasLocator.Instance.Tutorial;
        private readonly RectTransform rectTransform; // Rect of button
        private readonly MainButtonJob mainButtonJob; // Button component

        // Create and setup
        public LineTutorial(RectTransform rectTransform)
        {
            // Save components
            ...
            TextLocalization.Instance.AddLocalization(name, TextKeysHolder.SettingsButtonTutorial);
        }
