...
namespace Architecture.ModuleTrackTime
{
    ...
    /// </summary>
    public class LineTrackSourceMinutes : ITrackLine
    {
        ...
        public LineTrackSourceMinutes(RectTransform pool)
        {
            texts = SourceItemsCreator.CreateTextElements(pool, TrackPositions.PositionsCount, "Item Minutes"); 
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text =$"{MinutesPositionLoop.GetMinutes(trackPoint.OriginLinePosition): 00}";
        }
