...
namespace Architecture.ModuleTrackTime
{
    ...
    public class TrackScroll : IBehaviorSync
    {
        ...
        private const float inertiaMultiplier = 1f;
        ...
        // Create and setup
        public TrackScroll(GameObject touchArea, Transform setTrack, ITrackLine lineTrackSources)
        {
            // Create main components
            inertiaMultiplierDelta = lineTrackSources.DeltaScrollMultiplier();
            ...
            SyncWithBehaviour.Instance.AddObserver(trackPositions, AppSyncAnchors.TrackTimeModule);
