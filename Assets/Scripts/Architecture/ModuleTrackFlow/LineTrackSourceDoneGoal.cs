...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceDoneGoal : ITrackLine
    {
        ...
        public LineTrackSourceDoneGoal(RectTransform pool, Text[] texts,
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = $"{FlowInfoDone.CountGoalByLine(trackPoint.OriginLinePosition)} {AppFontCustomization.Done}";
        }
        ...
        public float TargetSizeInCenter() => 1.07f;
    }
}
