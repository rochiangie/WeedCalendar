...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceTimeHours : ITrackLine
    {
        ...
        public LineTrackSourceTimeHours(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.texts = texts;
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoTimeHours.ConvertToView(trackPoint.OriginLinePosition, texts[trackPoint.Id].fontSize);
        }
