...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceTimeSecondsGoal : ITrackLine
    {
        ...
        public LineTrackSourceTimeSecondsGoal(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.texts = texts;
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoTimeSeconds.ConvertToViewGoal(trackPoint.OriginLinePosition);
        }
