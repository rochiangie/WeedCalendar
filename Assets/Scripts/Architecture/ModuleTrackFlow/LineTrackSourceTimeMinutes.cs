...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceTimeMinutes : ITrackLine
    {
        ...
        public LineTrackSourceTimeMinutes(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.texts = texts;
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoTimeMinutes.ConvertToView(trackPoint.OriginLinePosition, texts[trackPoint.Id].fontSize);
        }
        ...
        public int? MaxLinePosition() => 1439;
