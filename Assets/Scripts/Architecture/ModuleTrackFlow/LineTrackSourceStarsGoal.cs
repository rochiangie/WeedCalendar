...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceStarsGoal : ITrackLine
    {
        ...
        public LineTrackSourceStarsGoal(RectTransform pool, Text[] texts,
        ...
        public void UpdatePoint(TrackPoint trackPoint) 
        {
            ...
            texts[trackPoint.Id].text = $"{FlowInfoStars.CountGoalByLine(trackPoint.OriginLinePosition)} {AppFontCustomization.Star}";
        }
        ...
        public float TargetSizeInCenter() =>  1.3f;
    }
}
