...
{
    // Component for visual of UI for rename day characteristic view
    public class VisualPart : IBehaviorSync
    {
        ...
        public VisualPart(RectTransform rectTransform, Action openedAction, Action closeAction,int blackoutLayer)
        {
            ...
            uiSyncItem.AddElement(rectTransform.Find("Default Name").GetComponent<Text>());
            ...
            screenBlackout.MessageBlackoutClicked = AppMessagesConst.BlackoutUpdateMarkerModuleClicked;
        }
