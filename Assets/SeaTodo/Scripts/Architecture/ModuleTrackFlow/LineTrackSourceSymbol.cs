...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceSymbol : ITrackLine
    {
        ...
        public LineTrackSourceSymbol(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.pool = pool;
            this.texts = texts;
        ...
        public void LinkPoint(TrackPoint trackPoint)
        {
            ...
            var symbol = trackPoint.Id == 0 ? AppFontCustomization.Down : AppFontCustomization.Up;
