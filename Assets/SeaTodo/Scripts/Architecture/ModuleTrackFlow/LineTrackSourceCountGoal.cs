...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceCountGoal : ITrackLine
    {
        ...
        public LineTrackSourceCountGoal(RectTransform pool, Text[] texts,
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoCount.CountGoalByLine(trackPoint.OriginLinePosition).ToString();
        }
        ...
        public int? MaxLinePosition() => 1088;
