...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceTimeHoursGoal : ITrackLine
    {
        ...
        public LineTrackSourceTimeHoursGoal(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.texts = texts;
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoTimeHours.ConvertToViewGoalWithName(trackPoint.OriginLinePosition);
        }
        ...
        public int? MaxLinePosition() => 999;
