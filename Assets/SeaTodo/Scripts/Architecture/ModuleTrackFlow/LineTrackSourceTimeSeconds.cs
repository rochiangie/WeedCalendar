...
namespace Architecture.ModuleTrackFlow
{
    ...
    /// </summary>
    public class LineTrackSourceTimeSeconds : ITrackLine
    {
        ...
        public LineTrackSourceTimeSeconds(RectTransform pool, Text[] texts, RectTransform[] rectTransforms, UIAlphaSync[] alphaSyncs)
        {
            this.texts = texts;
        ...
        public void UpdatePoint(TrackPoint trackPoint)
        {
            ...
            texts[trackPoint.Id].text = FlowInfoTimeSeconds.ConvertToView(trackPoint.OriginLinePosition, texts[trackPoint.Id].fontSize);
        }
        ...
        public int? MaxLinePosition() => 900;
